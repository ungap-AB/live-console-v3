...
import { MODES, afterReasonFor, audienceSees, confirmationCopy, requiresConfirmation } from './projectMode.ts'

test('bekräftelse krävs för exakt de fem övergångarna', () => {
  const confirmed = [
    ['live', 'after'],
    ['ondemand', 'after'],
    ['after', 'live'],
