# Bekräftelse Live → After — design reference
...
- `ConfirmLiveAfter.dc.html` — the artboard (a Design Component: an `<x-dc>`
...
Serve the folder (e.g. `python3 -m http.server`) and open `ConfirmLiveAfter.dc.html`;
